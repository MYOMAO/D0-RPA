...
double Prefiltertrk1pt = 1.0;

double Prefiltertrk2pt = 1.0;
...
{
D0ptL[m] = m * D0ptstep+ D0ptmin;
D0ptU[m] = (m+1) * D0ptstep + D0ptmin;
D0ptmid[m] = (D0ptL[m]+D0ptU[m])/2;
if(Dy[j]< 1 && Dy[j] > -1 && Dpt[j] > D0ptL[m] && Dpt[j]< D0ptU[m] && Dgen[j] == 23333 && Dtrk1Pt[j] > Prefiltertrk1pt && Dtrk2Pt[j] > Prefiltertrk2pt && abs(Dtrk1Eta[j])< 1.5 && abs(Dtrk2Eta[j])< 1.5 )
{
...
//if(abs(PVz[j])<15&& Dy[j]>-1. && Dy[j]<1. && Dtrk1highPurity[j] && Dtrk2highPurity[j] && abs(Dtrk1Eta[j])<1.5 && abs(Dtrk2Eta[j])<1.5 && DlxyBS[j]/DlxyBSErr[j]>2.5 && Dpt[j] > D0ptL[m] && Dpt[j]< D0ptU[m] && Dgen[j] == 23333 && Dtrk1Pt[j] > Prefiltertrk1pt && Dtrk2Pt[j] > Prefiltertrk2pt)
if(abs(PVz[j])<15&& Dy[j]>-1. && Dy[j]<1. && Dtrk1highPurity[j] && Dtrk2highPurity[j] && abs(Dtrk1Eta[j])<1.5 && abs(Dtrk2Eta[j])<1.5 && DlxyBS[j]/DlxyBSErr[j]>2.5 && Dpt[j] > D0ptL[m] && Dpt[j]< D0ptU[m] && Dgen[j] == 23333 && Dtrk1Pt[j] > Prefiltertrk1pt && Dtrk2Pt[j] > Prefiltertrk2pt && Dalpha[j]<0.12 && (DsvpvDistance[j]/DsvpvDisErr[j])>3.5 && Dtrk1PtErr[j]/Dtrk1Pt[j]<0.3 && Dtrk2PtErr[j]/Dtrk1Pt[j]<0.3)
{ 
...
double TotalEff = Acceffpt * PrefilterEff;

cout << "Acceptance Efficiency = " << Acceffpt << "  Prefilter Efficiency = " << PrefilterEff << "   Total Efficiency = " << TotalEff  << endl; 
