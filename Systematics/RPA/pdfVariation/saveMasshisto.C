...
Bool_t  isPbPb;
Float_t centmin,centmax,hiBinmin = 0,hiBinmax=200;
                   ...
                   TString outputfile="outfMasshisto/mass")
{
  ...
  seldata = Form("%s&&%s&&Dy>-0.535&&Dy<1.465&&Dtrk1Eta>-1.035&&Dtrk1Eta<1.965&&Dtrk2Eta>-1.035&&Dtrk2Eta<1.965",trgselection.Data(),cut.Data());
//  seldata = Form("%s&&%s&&hiBin>=%f&&hiBin<=%f&&Dy>-0.535&&Dy<1.465&&Dtrk1Eta>-1.035&&Dtrk1Eta<1.965&&Dtrk2Eta>-1.035&&Dtrk2Eta<1.965",trgselection.Data(),cut.Data(),hiBinMin,hiBinMax);
  ...
  selmc = Form("%s&&abs(Dy)<1.&&abs(Dtrk1Eta)<1.5&&abs(Dtrk2Eta)<1.5",cut.Data());
  centmin = centMin;
  centmax = centMax;
  hiBinmin = centMin*2;
  hiBinmax = centMax*2;
